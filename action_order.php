<?php 
	...
	if(!($_SESSION["state_login"])&& $_SESSION["state_login"]===true){
?>
	...
	if(mysqli_connect_errno())
		...
		$query="INSERT INTO `order`
			...
			if (mysqli_query($link,$query)=== true){
				...
				echo ("<p style='color:brown ;'><br/><b>کاربر گرامی $realname </b></p>");
				echo ("<p style='color:brown;'><br/><b>محصول $pro_name با کد  $pro_code به تعداد $pro_qty را سفارش داده اید </b></p>");
				echo ("<p style='color:red;'><br/><b>مبلغ قابل پرداخت برای سفارش ثبت شده$total_price تومان است</b>
				</p>");
				echo ("<p style='color:blue;'><b> پس از بررسی سفارش و تأیید آن با شما تماس گرفته خواهد شد</b>
				</p>");
